...
function FirstCarousel() {
  ...
  return (
    <Carousel className='bg-dark' controls={false} indicators={false} interval={4000}>
      ...
      <Carousel.Item interval={4000}>
        <div className="container text-center">
          <div className="row align-items-center">
            ...
            <div className="col">
              <img className="d-block w-100" src={require("../Assets/images/products/sonyXb910n-1.png")} alt="Third slide" />
            </div>
          </div>
        </div>
      </Carousel.Item>
